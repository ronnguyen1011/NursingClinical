    ...
    <main class="container" id="experience">
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <?php
                    // if user already submitted survey, display message instead of survey
                    if(isset($_COOKIE[SUBMITTED_SURVEY_KEY]) && $_COOKIE[SUBMITTED_SURVEY_KEY] === "confirmed"){
                        echo generateMessage("You have already submitted a survey, come back later", 
                                             "Survey Submission Detected");
                    }

                    // otherwise display survey
                    else {
                ?>
